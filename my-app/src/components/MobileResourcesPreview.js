...
const MobileResourcesPreview = () => {
  ...
  return (
    <Container>
      <Row>
        <Col>
        <Link to={"/resources/"} style={{textDecoration: "none"}}> {/*  + featureId */}
          <FeatureImageContainer>
            <FeatureImage style={{paddingBottom:"0px", marginBottom:"0px"}} src={testMobileResourceImage} />
          </FeatureImageContainer>
          <FeatureContent
            style={{
              padding: "0.5rem 1rem",
          ...
          >
            ...
            <FeatureContentp>
              ...
              elit in ullamco minim reprehenderit duis nostrud cupidatat. Nulla
              tempor consectetur cupidatat labore ipsum exercitation proident
              fugiat tempor cillum quis est sint exercitation.
            </FeatureContentp>
          </FeatureContent>
          </Link>
        </Col>
        ...
        <Col>
          {mobileResourcesData.map((resource) => (
            <Link to={"/resources/" + resource.id} key={resource.id} style={{textDecoration: "none"}}>
              <Resourcediv
                style={{
