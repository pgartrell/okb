...
import testTherapyResourceImage from "../images/testTherapyResourceImage.jpg";
import "../styles/MobileResourcesPreview.css";

const TherapyResourcesPreview = () => {
    const therapyResourcesData = [
        {
          id: 2,
          title: "Resource 1",
          content:
          ...
          <h1 className="resourceh1" >
            ...
            <div className="col-md-6 p-3">
              ...
              >
                <div className="feature-card">
                  <img className="feature-card-image" src={testTherapyResourceImage} />
            ...
            <div className="col-md-6 ">
              <Card className="resourceListContainer border-0">
                {therapyResourcesData.map((resource) => (
                  <Link
...
export default TherapyResourcesPreview